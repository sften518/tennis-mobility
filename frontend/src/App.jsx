...
const USER_ID = "user_1"; // シンプルな固定ID。封E��ログイン機�Eを追加する場合�Eここを変えめE
const schedule = {
  MON: {
    label: "MON",
    ...
    sections: [
      {
        ...
        duration: "7 min",
        items: [
          { name: "T-Spine Open the Book", sets: "3ÁE ea", cue: "Pause 2s at end range. Drive rotation from mid-back, not lumbar.", tennis: true, tennisNote: "Mirrors serve wind-up & backhand pull" },
          { name: "Deep Squat w/ Rotation", sets: "3ÁE ea", cue: "Actively reach the rotating arm to ceiling. Hold 2s.", tennis: true, tennisNote: "Low-ball forehand + torso dissociation" },
          { name: "T-Spine Windmills", sets: "2ÁE ea", cue: "Stack hips. Control the descent  Eno flopping.", tennis: false },
        ],
      },
      {
        ...
        duration: "7 min",
        items: [
          { name: "Blackburn I, Y, T, W", sets: "2ÁE ea position", cue: "Initiate from scapula, not traps. Full retraction & depression at top.", tennis: true, tennisNote: "Rotator cuff stability for serves & volleys" },
          { name: "Foam Roller Reach Through", sets: "3ÁE ea", cue: "Active protraction at end range. Feel the serratus engage.", tennis: true, tennisNote: "Scapular upward rotation = overhead range" },
          { name: "PVC/Band Dislocates", sets: "3ÁE0", cue: "Slow & controlled. Narrow grip only as far as you can maintain tension.", tennis: true, tennisNote: "Shoulder active ROM for serve motion" },
        ],
      },
      {
        ...
        duration: "6 min",
        items: [
          { name: "Plank Reach & Rotate", sets: "3ÁE ea", cue: "Rotate thorax, not hips. Lock the pillar.", tennis: true, tennisNote: "Trunk dissociation under load" },
          { name: "Bird Dogs", sets: "2ÁE0 ea", cue: "3s hold at full extension. Contralateral arm–leg = tennis kinetic chain.", tennis: true, tennisNote: "Arm–leg coordination = groundstroke pattern" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        duration: "8 min",
        items: [
          { name: "Hip CARs", sets: "3ÁE ea", cue: "Full circumduction under tension. Brace core  Eisolate the joint.", tennis: true, tennisNote: "Maintains full hip ROM for wide balls" },
          { name: "Hip Airplane", sets: "3ÁE ea", cue: "Controlled descent to end range. 2s hold. Drive back with glute, not momentum.", tennis: true, tennisNote: "Single-leg stability = consistent groundstroke base" },
          { name: "90/90 Internal Rotation", sets: "3ÁE ea", cue: "Active floor press with back shin. No collapse. Build load at IR end range.", tennis: true, tennisNote: "IR restriction kills hip drive in forehand" },
        ],
      },
      {
        ...
        duration: "7 min",
        items: [
          { name: "Cossack Squats", sets: "3ÁE ea", cue: "Pause at bottom. Active dorsiflexion on straight leg. Control return.", tennis: true, tennisNote: "Lateral lunge = wide forehand recovery" },
          { name: "Mini Band Fire Hydrants", sets: "2ÁE ea", cue: "Slow arc. Resist internal rotation at top. Feel glute med fully engage.", tennis: false },
          { name: "Kneeling Lateral Leg Lifts", sets: "2ÁE ea", cue: "Keep pelvis level. Lift from hip abductors, not waist hike.", tennis: false },
        ],
      },
      {
        name: "ACTIVE INTEGRATION",
        duration: "5 min",
        items: [
          { name: "Single Leg RDLs", sets: "3ÁE ea", cue: "Hinge to hamstring tension. Pause. Drive through heel  Eown the position.", tennis: true, tennisNote: "Hip hinge under load = approach shot balance" },
          { name: "Seated Leg Lifts Over KB", sets: "2ÁE ea", cue: "Lift from hip flexor. Hold 3s. Avoid leaning back to compensate.", tennis: false },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        duration: "8 min",
        items: [
          { name: "Single-Leg Calf Raises (slow)", sets: "3ÁE0 ea", cue: "3s up, 3s down. Full plantarflexion at top. Full dorsiflexion at bottom.", tennis: true, tennisNote: "Absorbs split-step landing force" },
          { name: "Split Stance Soleus Raises", sets: "3ÁE0 ea", cue: "Knee tracks over 3rd toe. Load into dorsiflexion end range  Edon't bounce.", tennis: true, tennisNote: "Soleus = primary Achilles load. Critical for tennis players." },
          { name: "Tib Raises", sets: "3ÁE5", cue: "Full dorsiflexion  Epause at top. Control eccentric phase.", tennis: true, tennisNote: "Anterior compartment control for quick stops" },
        ],
      },
      {
        ...
        duration: "7 min",
        items: [
          { name: "PVC 3-Point Hinge", sets: "3ÁE0", cue: "PVC contacts head, thoracic, sacrum throughout. Own the neutral spine.", tennis: true, tennisNote: "Athletic ready position = this hinge pattern" },
          { name: "Inch Worms", sets: "3ÁE", cue: "Walk out to full plank. Pause. Actively press floor away. Walk back slow.", tennis: false },
          { name: "Single-Leg Step Downs", sets: "2ÁE ea", cue: "Tap the heel, don't load. Control knee tracking. Eccentric focus.", tennis: true, tennisNote: "Deceleration control = injury prevention" },
        ],
      },
      {
        name: "ACTIVE INTEGRATION",
        duration: "5 min",
        items: [
          { name: "Front Foot Elevated Split Squats", sets: "3ÁE ea", cue: "Knee forward over toe  Eload ankle end range intentionally. Slow down phase.", tennis: true, tennisNote: "Open-stance forehand = this dorsiflexion demand" },
          { name: "Deep Squat Plate Rocks", sets: "2ÁE ea", cue: "Rock weight onto toes  Edrive ankle mobility actively. Stay in squat.", tennis: false },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        duration: "7 min",
        items: [
          { name: "Elbow to Elbow", sets: "3ÁE ea", cue: "Driving elbow reaches floor at end range. No lumbar compensation.", tennis: true, tennisNote: "Backhand pull-through motion" },
          { name: "Spiderman w/ Rotation", sets: "3ÁE ea", cue: "Press hips to floor, then rotate thorax maximally. Pause 2s at top.", tennis: false },
          { name: "Scorpions", sets: "2ÁE2 total", cue: "Reach foot actively across body. Control  Edon't drop. Feel thoracic load.", tennis: false },
        ],
      },
      {
        ...
        duration: "8 min",
        items: [
          { name: "Good Mornings", sets: "3ÁE0", cue: "Hinge to hamstring tension, pause. Drive hips forward  Eglute-initiated.", tennis: false },
          { name: "½ Kneeling Hamstring Extension on Wall", sets: "3ÁE ea", cue: "Active knee extension against wall. Load the hamstring at end range.", tennis: true, tennisNote: "Hamstring flexibility under active control" },
          { name: "Hip Bridges w/ Pause", sets: "3ÁE0", cue: "Full hip extension at top  E3s hold. Drive knees out. No ribflare.", tennis: false },
        ],
      },
      {
        name: "ACTIVE INTEGRATION",
        duration: "5 min",
        items: [
          { name: "Side Plank w/ Hip Abduction", sets: "2ÁE ea", cue: "Lift top leg to end range. Hold 2s. Control descent. Hips stacked.", tennis: true, tennisNote: "Lateral stability = backhand groundstroke base" },
          { name: "Deadbugs", sets: "2ÁE0 ea", cue: "Lower back pressed to floor throughout. Slow arm–leg extension. Full reach.", tennis: true, tennisNote: "Anti-extension core = racket acceleration control" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        duration: "6 min",
        items: [
          { name: "Hip CARs", sets: "2ÁE ea", cue: "Full circumduction. Maximum tension throughout. Brace core hard.", tennis: true, tennisNote: "Reassess hip range after the week" },
          { name: "Shoulder CARs", sets: "2ÁE ea", cue: "Full circumduction. Pack the shoulder. No compensation at trunk.", tennis: true, tennisNote: "Serving shoulder ROM check" },
          { name: "T-Spine Rotations on Wall", sets: "2ÁE ea", cue: "Hips locked against wall. Rotate only above. Active reach at end range.", tennis: true, tennisNote: "Isolates thoracic  Eno lumbar cheating" },
        ],
      },
      {
        ...
        duration: "8 min",
        items: [
          { name: "✦ Rotational Med Ball Wall Slams", sets: "3ÁE ea", cue: "Load hips, rotate thorax, accelerate arm. Catch & control eccentrically.", tennis: true, tennisNote: "Full kinetic chain activation  Eserve & groundstroke" },
          { name: "✦ Split-Step ↁELateral Bound", sets: "3ÁE ea", cue: "Land soft, absorb, explode laterally. Stick landing 2s. Reset.", tennis: true, tennisNote: "Trains the reactive mobility pattern specific to court movement" },
          { name: "Hip Airplane", sets: "2ÁE ea", cue: "Full end-range hold 3s. This is strength  Enot a balance drill.", tennis: true, tennisNote: "Final glute/hip check for the week" },
        ],
      },
      {
        name: "ACTIVE INTEGRATION",
        duration: "6 min",
        items: [
          { name: "Cossack Squats", sets: "2ÁE ea", cue: "Full depth, controlled. Pause at bottom. Own it.", tennis: true, tennisNote: "Wide footwork range of motion" },
          { name: "PVC/Band Overhead Squats", sets: "2ÁE", cue: "Overhead position demands everything: ankles, hips, thorax, shoulders.", tennis: true, tennisNote: "Integrated overhead mobility  Eserve position test" },
          { name: "Plank Reach & Rotate", sets: "2ÁE ea", cue: "Lock hips. Reach and rotate thorax only. Slow and deliberate.", tennis: false },
        ],
      },
    ],
  },
...
export default function TennisMobility() {
  ...
  // ── Check if all 5 days complete ↁEcelebrate & reset ──
  useEffect(() => {
    if (!loaded) return;
  ...
  return (
    <div style={{ fontFamily: "'DM Mono', 'Courier New', monospace", background: "#0C0C0C", minHeight: "100vh", color: "#E8E8E0", maxWidth: 680, margin: "0 auto", padding: "0 0 40px", position: "relative" }}>
      ...
      <div style={{ padding: "24px 20px 18px", borderBottom: "1px solid #1a1a1a" }}>
        ...
        {todayKey && (
          <div style={{ marginTop: 14, padding: "8px 12px", background: "#111", borderRadius: 8, border: `1px solid ${accentOf(schedule[todayKey].dark)}22`, display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: "#555", letterSpacing: 1 }}>TODAY  E/span>
            ...
            {activeDay !== todayKey && (
              <button onClick={() => setActiveDay(todayKey)} style={{ marginLeft: "auto", fontSize: 9, color: "#555", background: "transparent", border: "1px solid #2a2a2a", borderRadius: 4, padding: "2px 8px", cursor: "pointer", letterSpacing: 1 }}>GO ↁE/button>
            )}
          </div>
        )}
        {!todayKey && (
          <div style={{ marginTop: 14, padding: "8px 12px", background: "#111", borderRadius: 8, fontSize: 11, color: "#444", letterSpacing: 1 }}>
            REST DAY  ESee you Monday 🎾
          </div>
        )}
        ...
        {DAYS.map((d) => {
          ...
          return (
            <button key={d} onClick={() => setActiveDay(d)} style={{ background: isActive ? s.dark : "transparent", border: "none", borderRight: "1px solid #151515", padding: "13px 0 11px", cursor: "pointer", color: isActive ? "#fff" : dayDone ? accentOf(s.dark) : "#444", transition: "all 0.15s", position: "relative" }}>
              ...
              <div style={{ fontSize: 9, marginTop: 3, color: isActive ? "rgba(255,255,255,0.6)" : dayDone ? accentOf(s.dark) : "#2a2a2a", letterSpacing: 0.5 }}>{dayDone ? "✁E : p > 0 ? `${p}%` : "·"}</div>
            </button>
          );
        })}
      </div>
              ...
              return (
                <div key={ii} onClick={() => toggle(key)} style={{ display: "grid", gridTemplateColumns: "20px 1fr", gap: 12, padding: "11px 10px", marginBottom: 4, borderRadius: 8, cursor: "pointer", background: done ? "#111" : "transparent", border: "1px solid", borderColor: done ? "#1e1e1e" : "transparent", transition: "all 0.15s" }}>
                  <div style={{ width: 18, height: 18, borderRadius: 4, marginTop: 2, flexShrink: 0, border: `1.5px solid ${done ? accent : "#2a2a2a"}`, background: done ? accent : "transparent", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s" }}>
                    {done && <span style={{ color: "#000", fontSize: 10, fontWeight: 900, lineHeight: 1 }}>✁E/span>}
                  </div>
                  <div>
            ...
            {history.map((h, i) => (
              <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <span style={{ fontSize: 10, color: "#3EC98A" }}>✁E/span>
      ...
      <div style={{ margin: "16px 16px 0", padding: "14px 16px", background: "#0a0a0a", borderRadius: 8, borderLeft: `2px solid ${day.dark}`, fontSize: 11, color: "#333", lineHeight: 1.6 }}>
        ...
        Every rep should feel like effort at end range. If you can do it mindlessly, you're not working the mobility  Eyou're just moving through it.
      </div>
    </div>
  );
}
